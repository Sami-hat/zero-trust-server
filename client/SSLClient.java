...
public class SSLClient {
    ...
    private void reconnect() throws IOException, NoSuchAlgorithmException, KeyManagementException, InterruptedException {
        disconnect();
    ...
    private static class FileOperation {
        enum Type { UPLOAD, DOWNLOAD, SHARE, DELETE, REVOKE }
                    ...
                    try {
                        switch (op.type) {
                            case UPLOAD:
                                ...
                                break;
                            case DOWNLOAD:
                                downloadFile(op.filename, op.targetUser != null ? op.targetUser : username, op.password);
                                break;
                            case SHARE:
